...
class Launcher:
    ...
    def launch(self, custom_config, *args):
        ...
        for new_rank in range(0, self.nranks):
            ...
            new_config.model_name = custom_config.model_name
            new_config.doc_maxlen = custom_config.doc_maxlen
            new_config.index_path = custom_config.index_path
            # self.run_config.index_path_ = custom_config.index_path_
    ...
    def launch_without_fork(self, custom_config, *args):
        ...
        new_config.model_name = custom_config.model_name
        new_config.doc_maxlen = custom_config.doc_maxlen
        new_config.index_path = custom_config.index_path_
