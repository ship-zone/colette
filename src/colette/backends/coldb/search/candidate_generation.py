...
class CandidateGeneration:
    def __init__(self, use_gpu=True, gpu_id=None):
    ...
    def generate_candidates(self, config, Q):
        ...
        if self.use_gpu:
            pids, pids_counts = pids.cuda(self.gpu_id), pids_counts.cuda(self.gpu_id)
