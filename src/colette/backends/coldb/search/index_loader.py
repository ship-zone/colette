...
from ..utils.utils import lengths2offsets, print_message
from .strided_tensor import StridedTensor


class IndexLoader:
    def __init__(
        self, index_path, use_gpu=True, load_index_with_mmap=False, gpu_id=None
    ):
    ...
    def _load_codec(self):
        ...
        self.codec = ResidualCodec.load(self.index_path, self.gpu_id)
    ...
    def _load_ivf(self):
        ...
        if False:
            ...
            ivf = StridedTensor(
                ivf, ivf_lengths, use_gpu=self.use_gpu, gpu_id=self.gpu_id
            )
