...
# RESIZED_HEIGHT_WIDTH = 320
RESIZED_HEIGHT_WIDTH = 748
...
class TrainCollator:
    ...
    def __call__(self, features: List[Tuple[str, List[str]]]):
                    ...
                    "content": [
                        {
                            "type": "image",
                            "image": image,
                            "resized_height": RESIZED_HEIGHT_WIDTH,
                            "resized_width": RESIZED_HEIGHT_WIDTH,
                        },
        ...
        passage_image_inputs, passage_video_inputs = process_vision_info(
            passage_messages
        )
